...
| pass | info | `atlas_metric_contract` | Atlas Map uses render-safe workbook fields for utilisation classification, funded-plan gap, utilisation gap, supply response and provider rate. |
