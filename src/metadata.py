...
FIELD_DESCRIPTIONS = {
    ...
    "funded_plans_per_1000_delta_from_national_median": "Funded plans per 1,000 population minus the national service-area median for the same quarter.",
    ...
    "provider_saturation_delta_from_national_median": "Funded plans per active provider minus the national service-area median for the same quarter. Higher values indicate higher provider load.",
    ...
    "active_provider_rate_delta_from_national_median": "Active providers per 1,000 funded plans minus the national service-area median for the same quarter.",
    ...
    "atlas_utilisation_median_band": "Atlas colour band derived from mean plan utilisation minus the national service-area median for the same quarter.",
...
FIELD_CALCULATIONS = {
    ...
    "funded_plans_per_1000_delta_from_national_median": "funded_plans_per_1000 - benchmark_national_median_funded_plans_per_1000",
    ...
    "provider_saturation_delta_from_national_median": "funded_plans_per_active_provider - benchmark_national_median_provider_saturation",
    ...
    "active_provider_rate_delta_from_national_median": "active_providers_per_1000_funded_plans - benchmark_national_median_active_providers_per_1000_funded_plans",
    "atlas_utilisation_median_band": "categorise mean_plan_utilisation_delta_from_national_median as below, near or above national median",
